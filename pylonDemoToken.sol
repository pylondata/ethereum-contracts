...
contract PYLON is owned, token {
        ...
        returns (uint proposalID)
    {
        ...
        InvestmentOffer p2 = investmentOffer[proposalID];
    ...
    {
        InvestmentOffer p = investmentOffer[investmentNumber];
        ...
        returns (uint voteID)
    {
        ...
        InvestmentOffer p = investmentOffer[investmentNumber];                  // Get the investment Offer
